                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control force-check" id="nomeCliente" value="<?= $cliente->getNome() ?>">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label for="cpf" class="form-label">CPF:</label>
                            <input type="text" class="form-control force-check cpf" id="cpf" value="<?= $cliente->getCpf() ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label for="rg" class="form-label">RG:</label>
                            <input type="text" class="form-control force-check rg" id="rg" value="<?= $cliente->getRg() ?>">
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="dataNascimento" class="form-label">Data de Nacimento:</label>
                            <input type="text" class="form-control force-check data" id="dataNascimento" value="<?= $cliente->getDataNascimento() ?>">
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="dataNascimento" class="form-label">Telefone:</label>
                            <input type="text" class="form-control force-check celular" id="dataNascimento" value="<?= $cliente->getTelefone() ?>">
                        </div>
                    </div>
                </div>
            </div>
