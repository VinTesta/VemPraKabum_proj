                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control force-check cpf" data-validate="cpf" name="cpf" id="cpf" value="<?= $cliente->getCpf() ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label for="rg" class="form-label">RG:</label>
                            <input type="text" class="form-control force-check rg" data-validate="rg" name="rg" id="rg" value="<?= $cliente->getRg() ?>">
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="dataNascimento" class="form-label">Data de Nacimento:</label>
                            <input type="text" class="form-control force-check datepicker" data-validate="date" name="datanascimento" id="datanascimento" value="<?= $cliente->getDataNascimento() ?>">
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="telefone" class="form-label">Telefone:</label>
                            <input type="text" class="form-control force-check celular" data-validate="tell" name="telefone" id="telefone" value="<?= $cliente->getTelefone() ?>">
                        </div>
                    </div>
                </div>
            </div>
